...
public class DaftarActivity extends AppCompatActivity {
    ...
    //Deklarasi variabel dengan tipe data EditTextt
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtrepass =findViewById(R.id.edPassword);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    //Membuat kondisi untuk  mengecek apakah isi dari EditText password fan EditText repassword
                    //sama atau tidak
